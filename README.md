...
<!-- SKILL_COUNT -->69<!-- /SKILL_COUNT --> specialized skills across 12 categories covering languages, backend/frontend frameworks, infrastructure, APIs, testing, DevOps, security, data/ML, and platform specialists.
...
**Built for Claude Code** | **<!-- WORKFLOW_COUNT -->9<!-- /WORKFLOW_COUNT --> Workflows** | **<!-- REFERENCE_COUNT -->373<!-- /REFERENCE_COUNT --> Reference Files** | **<!-- SKILL_COUNT -->69<!-- /SKILL_COUNT --> Skills**
