---
title: Claude Skills
description: 69 specialized skills for Claude Code — progressive disclosure, context engineering, and full-stack coverage.
template: splash
hero:
...
<CardGrid stagger>
  <Card title="69 Skills" icon="puzzle">
  ...
  <Card title="373 References" icon="open-book">
